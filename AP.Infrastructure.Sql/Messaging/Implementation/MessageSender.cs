...
namespace AP.Infrastructure.Sql.Messaging.Implementation
{
    using System;
    ...
    public class MessageSender : IMessageSender
    {
        ...
        {
            using (var connection = new SqlConnection(name))
            {
                connection.Open();
        ...
        public void Send(IEnumerable<Message> messages)
        {
            ...
            { 
                ...
                using (var transaction = connection.BeginTransaction(IsolationLevel.ReadCommitted))
                {
                    ...
                    {
                        this.InsertMessage(message, connection, transaction);
                    }
        ...
        private void InsertMessage(Message message, DbConnection connection, SqlTransaction transaction = null)
        {
