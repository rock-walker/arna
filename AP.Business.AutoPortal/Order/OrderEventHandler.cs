...
namespace AP.Business.AutoPortal.Order
{
        ...
        IEventHandler<AnchorUnassigned>
    {
        ...
        public OrderEventHandler(IDbContextScopeFactory contextFactory, IOrderRepository orderRepository, ILogger<OrderEventHandler> logger)
        {
        ...
        public void Handle(OrderPlaced @event)
        {
            ...
            {
                orderRepository.Add(new Order(@event.WorkshopId, @event.SourceId, @event.AccessCode));
                context.SaveChanges();
            }
        }
        ...
        private bool ProcessOrder(Expression<Func<Order, bool>> lookup, Action<Order> orderAction)
        {
            using (var context = this.contextFactory.Create())
            {
                var order = orderRepository.GetAnchor(lookup);
                if (order != null)
                {
