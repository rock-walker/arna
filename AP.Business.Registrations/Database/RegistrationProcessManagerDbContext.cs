...
namespace AP.Business.Registration.Database
{
    using Infrastructure.Sql.Processes;
    using Microsoft.EntityFrameworkCore;
    using EntityFramework.DbContextScope.Interfaces;

    public class RegistrationProcessManagerDbContext : DbContext, IDbContext
    {
        public const string SchemaName = "WorkshopRegistrationProcesses";

        public RegistrationProcessManagerDbContext(DbContextOptions<RegistrationProcessManagerDbContext> options) : base(options)
        {
        }
